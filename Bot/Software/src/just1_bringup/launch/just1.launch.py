...
def generate_launch_description():
    ...
    icp_odom_node = Node(
        ...
        name="icp_odometry",
        output="screen",
        parameters=[  # You can also see these parameters in Foxglove
            ...
            {"Icp/MaxTranslation": "0.5"},  # Max translation distance between scans
            {"Icp/MaxRotation": "0.5"},  # Max rotation between scans
            {"Odom/ResetCountdown": "1"},  # Reset odom when lost for 1 frame
        ],
        remappings=[
            ("/imu", "/imu/synced"),
            ("/scan", "/scan/synced"),
    ...
    rtabmap_slam_node = Node(
        ...
        parameters=[
            ...
            {"approx_sync": True},
            {"Mem/IncrementalMemory": "true"},  # ensure mapping mode
        ],
        remappings=[
            ("/imu", "/imu/synced"),
            ("/scan", "/scan/synced"),
        ...
        arguments=[
            "--delete_db_on_start",  # ensure mapping mode
            "--ros-args",
            "--log-level",
            "warn",
        ],
    ...
    # You can see the parameters in the config/nav2_params.yaml file
    ################
