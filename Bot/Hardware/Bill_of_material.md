...
| Wheels + Encoder Motors | 1 | MC100 60mm Mecanum Wheel Kit — includes 4× TT encoder motors + wheel adapters | [Link](https://www.amazon.com/Professional-Mecanum-Chassis-Raspberry-Omnidirectional/dp/B09P2XR91Z) | $35 | Kit ships with 60mm mecanum wheels, TT-form-factor motors with built-in hall-effect encoders, and all mounting hardware. Encoders provide per-wheel rotational feedback for closed-loop PID, odometry, and precision maneuvers like docking. The metal chassis included in the kit is not used — we 3D-print our own. |
